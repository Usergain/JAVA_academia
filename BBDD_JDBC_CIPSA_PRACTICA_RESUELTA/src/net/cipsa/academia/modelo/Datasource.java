...
public class Datasource {
	...
	public Datasource() throws Exception {
		...
		InputStream isr = Datasource.class.getResourceAsStream("/config3.properties");
		...
		cadenaConexion = "jdbc:mysql://" + host + "/" + bd + "?user=" + user + "&password=" + pass + "&serverTimezone=UTC";
		System.out.println("DEBUG: " + cadenaConexion);
	}
