...
public class ProductoRepositorioImpl implements Repositorio<Producto> {
    ...
    public List<Producto> listar() throws SQLException {
        ...
        //En este pool no estamos cerrando la conexion como en el JDBC para web, sino que estamos liberando el pool
    ...
    public Producto guardar(Producto producto) throws SQLException {
        ...
        /*Statement.RETURN_GENERATED_KEYS para que le asigne le ultimo id, es una manera de abstraccion, ya que
             cada BBDD tiene sus pequeñas peculiaridades. De esta forma vale para todas*/
