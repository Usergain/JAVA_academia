...
<div class="container">
    ...
    <div class="row mb-5">
        <div class="col-lg-12 text-center mt-3">
            <h1 class="text-center">Tecnico: <%=tecnico.getNombre()%>
            </h1>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="eliminar_enfermero_paciente?id_paciente=<%=pacientes.get(i).getId()%>&id_enfermero=<%=tecnico.getId()%>"
                ...
                <div class="col-lg-12 mt-3">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="asignar_tecnico_paciente?id_paciente=<%=pacientes_no_asignados.get(i).getId()%>&id_tecnico=<%=tecnico.getId()%>"
