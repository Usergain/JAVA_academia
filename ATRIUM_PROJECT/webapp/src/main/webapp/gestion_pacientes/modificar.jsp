            ...
            <div class="col-lg-4">
                <div clas="form-group">
                    <label>Nombre: </label> <input type="text"
                                                   ...
                                                   value="<%=persona.getNombre()%>" class="form-control">
                </div>
            </div>
            <div class="col-lg-4">
                <div clas="form-group">
            ...
            <div class="col-lg-4">
                <div clas="form-group">
                    <label>Edad: </label> <input type="number"
                                                 placeholder="Entre la edad" value="<%=persona.getEdad()%>" name="edad"
                                                 class="form-control">
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row mt-3">
            <div class="col-lg-12">
                <div clas="form-group">
                    ...
                    <textarea placeholder="Entre la dirección" rows="3" cols="" class="form-control"
                              name="direccion"><%=persona.getDireccion()%></textarea>
                </div>
            </div>
        </div>
