 ...
 * 
 */
@WebServiceClient(name = "ServicioWsImplService", targetNamespace = "http://services.jaxws.webapp.aartaraz.org/", wsdlLocation = "http://localhost:8080/webapp-jaws/ServicioWsImpl?wsdl")
public class ServicioWsImplService
    extends Service
{

    private static final URL SERVICIOWSIMPLSERVICE_WSDL_LOCATION;
    private static final WebServiceException SERVICIOWSIMPLSERVICE_EXCEPTION;
    private static final QName SERVICIOWSIMPLSERVICE_QNAME = new QName("http://services.jaxws.webapp.aartaraz.org/", "ServicioWsImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webapp-jaws/ServicioWsImpl?wsdl");
    ...
    public ServicioWs getServicioWsImplPort() {
        return super.getPort(new QName("http://services.jaxws.webapp.aartaraz.org/", "ServicioWsImplPort"), ServicioWs.class);
    }
    ...
    public ServicioWs getServicioWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.jaxws.webapp.aartaraz.org/", "ServicioWsImplPort"), ServicioWs.class, features);
    }
