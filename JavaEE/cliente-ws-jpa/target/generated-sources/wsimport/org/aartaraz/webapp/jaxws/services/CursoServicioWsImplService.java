 ...
 * 
 */
@WebServiceClient(name = "CursoServicioWsImplService", targetNamespace = "http://services.jaxws.webapp.aartaraz.org/", wsdlLocation = "http://localhost:8080/webapp-jaws-jpa/CursoServicioWsImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/webapp-jaws-jpa/CursoServicioWsImpl?wsdl");
