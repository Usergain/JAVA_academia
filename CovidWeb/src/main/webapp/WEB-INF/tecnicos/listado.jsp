...
<title>Listado de tecnicos</title>
...
<body>
	...
	<%
	ArrayList<Persona> personas = PersonasDAO.listar_tecnicos();
	%>
	<div class="container">
		<div class="row">
			<div class="col-lg-12 mt-3">
				<h1 class="text-center">Listado de tecnicos</h1>
			</div>
		</div>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>							
								<a href="asignar_paciente?id=<%=personas.get(i).getId() %>" class="btn btn-primary text-white"><i
